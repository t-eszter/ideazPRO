"""
Django settings for ideazApp project.
...
ALLOWED_HOSTS = [
    # '127.0.0.1',
    # 'localhost',
    # 'data-driven-design.herokuapp.com',
    # '0.0.0.0',
...
WSGI_APPLICATION = 'ideazApp.wsgi.application'
